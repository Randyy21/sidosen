                    ...
                    <div class="grid grid-cols-2 h-full">
                        <div class="flex items-center justify-center">
                            <div class="aspect-square w-52">
                                <img src="https://img.freepik.com/premium-photo/modern-business-man-formal-suit-standing-with-crossed-arms-isolated-grey-background-businesspeople-concept_533057-1641.jpg" class="rounded-full aspect-square object-cover float-right" alt="">
                            </div>
                        </div>
                        <div>
                            <div class="pe-2  pb-1">
