...
<body class="bg-[#F0F1F3]">
            ...
            <ul class="space-y-2 font-medium">
               ...
               <li>
                  <a href="/orasi" class="{{ (request()->is('orasi*')) ? 'text-green-400' : 'text-gray-900'}} flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                     ...
                     <span class="ms-3">Orasi Ilmiah</span>
                  </a>
               </li>
               <li>
      ...
      <nav class="bg-white border-gray-200  w-full flex justify-end items-center h-20">
         <div class="flex pr-10 items-center">
            <p class="pr-2">RAD Management</p>
            <div class="aspect-square h-10 w-10">
              <img src="https://img.freepik.com/premium-photo/modern-business-man-formal-suit-standing-with-crossed-arms-isolated-grey-background-businesspeople-concept_533057-1641.jpg" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="rounded-full aspect-square object-cover float-right cursor-pointer" alt="">
            </div>
         </div>
